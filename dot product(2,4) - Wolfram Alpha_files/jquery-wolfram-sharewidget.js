        ...
        var content = '<h1 class="ir"></h1>' +
                        '<ul>' +
                         ...
                         '<ul id="moreSocial">' +
                           ...
                           '</li>' +
                         '</ul>' +
                         '<span id="shortUrl"><label for="shortUrlBox">Link to results: </label><input type="text" id="shortUrlBox" readonly="true" value="http://wolfr.am/"></span><a href="#share" class="more">more</a><a href="#_" class="less">less</a>';
